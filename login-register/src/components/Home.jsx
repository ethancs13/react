                ...
                <div>
                  ...
                  <div className='form-wrapper'>
                    <form encType='multipart/form-data' className='form__container' onSubmit={handleSubmit}>
                        ...
                        <div className="expense-section">
                          <div className='top-items' >
                            ...
                            <div className='input_wrapper'>
                              <input className='cellphone color-billable' name='cellphone' value={cellphone} onChange={(e) => setCell(e.target.value)} required />
                      ...
                      <h2>Food/Restaurant Expenses</h2>
                        <div className='food-section'>
                          <button onClick={(e) => handleModal}>mmodal</button>
